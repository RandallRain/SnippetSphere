/*
 * In career projects, Sort module pages by important, display all 
 * uncompleted tasks in each module page sorted by due date.
*/
...
for (let page of pages)
{
    ...
    if (tasks.length > 0) 
    {
        ...
        dv.paragraph("important: " + page.important + ", urgent: " + page.urgent);
    }
}